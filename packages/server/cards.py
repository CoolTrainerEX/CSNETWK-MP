...
from packages.shared.cards import Card, CardID, Color
...
# Specific Effect Handlers
    ...
    def _apply_damage_spell(self, effect_text: str, targets: Set[str], player: str) -> None:
    ...
    def _apply_heal_spell(self, effect_text: str, targets: Set[str], player: str) -> None:
