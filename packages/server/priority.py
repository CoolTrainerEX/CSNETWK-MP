...
class PriorityMixin:
    ...
    def _handle_priority_pdu(
        ...
        elif pdu.type == Type.TRIGGER_ORDER_RESPONSE:
            return self._handle_trigger_order_response(pdu, player, holder, result)
        elif pdu.type == Type.TRIGGER_CHOICE_RESPONSE:
